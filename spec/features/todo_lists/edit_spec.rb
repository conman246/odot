...
describe "Editing todo lists" do
	...
	it "updates a todo list successfully with correct information" do
		...
		todo_list.reload #this will fetch the most recent information in the database and load it into the necessary variable. Without this, todo_list.title would incorrectly produce an error because the new data had not been reloaded yet.
